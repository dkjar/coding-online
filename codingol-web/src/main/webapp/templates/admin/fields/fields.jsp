<#include "/base/childheader.jsp" parse=true encoding="utf-8">
 <table	class="datagrid" 
	data-url="${ProjectPath}/fieldsController/indexdata.htm?tableid=${tableid}"  
...
<div id="fields-toolbar" >
	<div class="toolbars">
		<div style="float:left;">
			...
			<a href="javascript:void(0)" action="method:'add',url:'../fieldsController/edit.htm?tableid=${tableid}'" class="easyui-linkbutton" data-options="iconCls:'icon-add'" >添加</a>
