...
<table	class="datagrid" data-singleselect="false"
	data-url="${ProjectPath}/departmentController/selectuserdata.htm?departid=${departid}"  
...
<div id="department-toolbar" >
	<div class="toolbars">
		<div style="float:left;">
			...
			<b action="method:'ajax',grid:'id',url:'../departmentController/adddepartmentuser.htm?departid=${departid}'"  class="select-button hidden">添加</b>
		</div>
	</div>
</div>
