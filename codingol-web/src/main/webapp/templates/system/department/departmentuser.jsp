...
<table	class="datagrid" data-singleselect="false"
	data-url="${ProjectPath}/departmentController/departmentuserdata.htm?departid=${departid}"  
...
<div id="department-toolbar" >
	<div class="toolbars">
		<div style="float:left;">
			...
			<a href="javascript:void(0)" action="method:'addgrid',url:'../departmentController/selectuser.htm?departid=${departid}'" class="easyui-linkbutton" data-options="iconCls:'icon-add'" >添加</a>
			...
			<a href="javascript:void(0)" action="method:'delete',grid:'id',url:'../departmentController/deldepartmentuser.htm?departid=${departid}'" class="easyui-linkbutton" iconCls="icon-delete"  >删除</a>
		</div>
	</div>
</div>
